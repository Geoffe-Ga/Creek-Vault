...
class FlyProviderDriver:
    ...
    def list_resources(self) -> list[ProviderResource]:
        ...
        for app_name in self._org_app_names():
    ...
    def _app_resources(self, app_name: str) -> list[ProviderResource]:
        ...
        resources.extend(
            self._machine_resource(machine, allocation_id) for machine in machines
        )
    ...
    def _machine_resource(
        ...
        return ProviderResource(
            ...
            state_since=FlyProviderDriver._optional_instant(machine.get("updated_at")),
        )
