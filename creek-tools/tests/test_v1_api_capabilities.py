...
def test_a_present_vault_advertises_only_the_built_capabilities(
    ...
    """At #1799 that is every published capability, withdrawal too.
    ...
    a diff: a ninth capability has to add its name here, and a handler wired
    ...
    ``drive-connector`` and ``pipeline`` are withheld — is asserted separately
    below.
